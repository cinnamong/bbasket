...
if($rece_address == "") error("받으시는 분 주소가 빠졌습니다.");
...
// 상품 구매 적립금 적용
if($oper_info->reserve_use == "Y" && $oper_info->reserve_buy > 0 && $wiz_session[id] != ""){
	$reserve_buy = $oper_info->reserve_buy;
	$reserve_price = $total_price * $reserve_buy / 100;
}
