...
if($pay_result == "00"){
	...
	$sql = "insert into wiz_order values(
					...
					'".$order_info[reserve_use]."', '".$order_info[reserve_price]."', '".$order_info[deliver_price]."', '".$order_info[deliver_num]."', '".$order_info[discount_price]."', '".$order_info[prd_price]."', '".$order_info[total_price]."', 
