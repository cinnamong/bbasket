...
include "../shop/prd_category.inc";			// 카테고리
...
?>
               ...
               $sql = "select wp.prdcode, wp.prdname, wp.prdno, wp.model, wp.stortexp, wp.reserve, wp.sellprice, wp.prdimg_R, wp.popular, wp.recom, wp.new, wp.sale, wp.shortage, wp.stock, wp.conprice from wiz_cprelation wc, wiz_product wp where $catcode_sql $grp_sql wc.prdcode = wp.prdcode and wp.showset != 'N' $order_sql";
               ...
               if($cat_info->prd_num == "" || $cat_info->prd_num <= 0) $cat_info->prd_num = 18;
               ...
               <table border=0 cellpadding=0 cellspacing=0 width=100%>
				<tr><td align=center><?=$subimg?></td></tr>
					<tr>
					  <td align="center">
			            ...
			            ?>
			             <td width=6></td>
						    <td style="padding:15 5 15 5" valign=top>
								...
								<a href="prd_view.php?prdcode=<?=$row->prdcode?>&page=<?=$page?>"><tr><td align=center><?=cut_str($row->prdno,40)?></td></tr>
 <tr><td align=center><?=cut_str($row->model,30)?></td></tr></a>
									<tr><td align=center><?=$sp_img?></td></tr>
									<? if($row->conprice != "0"){?> <tr><td align=center class="conprice"><?=number_format($row->conprice)?>원</td></tr><?}?>
						   ...
						   <?
								...
								if($total <= 0) echo "<tr><td align=center height=50>상품 준비중입니다.<br>엄선된 상품으로 찾아 뵙겠습니다.</td></tr>";
							?>
							</table>
