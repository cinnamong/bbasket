							    ...
							    <td>
									...
									<tr><td bgcolor=#F9F9F9 style="padding:10">
										...
										<tr><td style="padding:5">
													...
													<tr height=25>
														<td colspan=3><br><font color="#317FB1">* 정확한 결제를 위해 성실하게 입력해 주세요.</font></td>
													</tr>
													</table>
										</td></tr>
										</table>
							...
							<tr><td style="padding:15 0 0 0">
									...
									<tr><td bgcolor=#F9F9F9 style="padding:10" colspan=2>
										...
										<tr><td style="padding:5">
													...
													<tr height=25>
														<td colspan=3><br><font color="#317FB1">* 배송 지연을 피하기 위해서는 받으시는 분의 주소가 정확해야 합니다.</font></td>
													</tr>
													</table>
										</td></tr>
										</table>
									...
									<tr><td bgcolor=#F9F9F9 style="padding:10">
										...
										<tr><td style="padding:5">
								                  ...
								                  for($ii=0; $ii<count($pay_method)-1; $ii++){
								                     ...
								                     else if($pay_method[$ii] == "PH") $pay_title = "PayPal 결제";
