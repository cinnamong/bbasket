...
<? include "../inc/header.inc"; ?>
                                              ...
                                              <td>
                                                ...
                                                <table width="670" border="0" cellspacing="0" cellpadding="0">
                                                  <tr align="center"> 
                                                    ...
                                                    <td width="160" bgcolor="EAF0F7">주문번호 </td>
                                                ...
                                                <?
                                                $sql = "select order_date, orderid, send_name, send_id, pay_method, total_price, status from wiz_order where status != '' order by orderid desc  limit 5";
                                                ...
                                                <table width="670" border="0" cellspacing="0" cellpadding="0">
                                                  <tr align="center" bgcolor="#FFFFFF"> 
                                                    ...
                                                    <td width="160"><a href="../order/order_info.php?orderid=<?=$order_info->orderid?>&page=<?=$page?>&<?=$param?>"><?=$order_info->orderid?></a></td>
                                          ...
                                          <table width="710" height="10" border="0" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td width="350">
		                                          ...
		                                          <table width="320" height="1" border="0" cellpadding="0" cellspacing="0">
		                                            <tr><td bgcolor="E4E4E4"></td></tr>
		                                          </table>
		                                          <table width="320" height="5" border="0" cellpadding="0" cellspacing="0">
		                                            <tr><td></td></tr>
		                                          </table>
		                                           <?
    ...
    <!--     신규게시물     -->
                                                ...
                                                <?
                                                $sql = "select wb.idx,wb.code,wb.subject,wb.wdate,wp.title from wiz_bbs wb, wiz_bbspro wp where wb.code = wp.code order by wb.wdate desc limit 8";
                                                $result = mysql_query($sql) or error(mysql_error());
                                                while($row = mysql_fetch_object($result)){
                                                ...
                                                <table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
                                                  <tr> 
                                                    <td width="350" height="22">
                                                      ...
                                                      &nbsp; - <a href="../bbs/bbs_view.php?code=<?=$row->code?>&prino=<?=$row->prino?>" class="1"><?=cut_str($row->subject,25)?></a> <?=$new_icon?>
                                                    </td>
                                                  </tr>
                                                </table>
                                                <?
                                          ...
                                          <table width="710" height="10" border="0" cellpadding="0" cellspacing="0">
                                            <tr> 
                                              <td width="350" valign="top">
                                                ...
                                                <table width="350" border="0" cellspacing="0" cellpadding="0">
                                                  <tr> 
                                                    <td width="300" height="22"><strong>&nbsp;&nbsp;&nbsp;질문과 답변 </strong></td>
                                                    <td width="46"><a href="../bbs/bbs_list.php?code=qna"><img src="../image/bt_more.gif" width="45" height="15" border="0"></a></td>
                                                  </tr>
                                                </table>
                                                <table width="350" height="1" border="0" cellpadding="0" cellspacing="0">
                                                  <tr><td bgcolor="E4E4E4"></td>
                                                ...
                                                <?
                                                $sql = "select prino,subject,wdate from wiz_bbs where code = 'qna' order by prino desc limit 3";
                                                $result = mysql_query($sql) or error(mysql_error());
                                                while($row = mysql_fetch_object($result)){
                                                	if($row->wdate >= date('Y-m-d')) $new_icon = "<img src='../image/icon_new.gif'>";
                                                	else $new_icon = "";
                                                ...
                                                <table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
                                                  <tr> 
                                                    <td width="300" height="22"><img src="../image/icon_dot.gif"> <a href="../bbs/bbs_list.php?code=qna&prino=<?=$row->prino?>" class="1"><?=cut_str($row->subject,35)?></a> <?=$new_icon?></td>
