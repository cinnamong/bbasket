                                        ...
                                        <td align="center" valign="top" bgcolor="#FFFFFF">
                                          ...
                                          <table width="97%" border="0" cellspacing="0" cellpadding="0">
                                            <tr align="center" bgcolor="E9E7E7"> 
                                              ...
                                              <td width="70"><a href="<?=$PHP_SELF?>?orderkey=salecnt&orderby=<?=$sale_orderby?>&<?=$param?>" class="3"><? if($sale_orderby == "desc") echo "▲"; else echo "▼"; ?> 장바구니</a></td>
                                            ...
                                            <?
                                          	...
                                          	// 상품그룹
								                     ...
								                     if(!empty($orderkey) && !empty($orderby)) $order_sql = " order by $orderkey $orderby, wp.prior desc";
															...
															$sql = "select prdcode, prdname, prdimg_R, viewcnt, deimgcnt, salecnt, ordercnt, cancelcnt, comcnt from wiz_product wp where prdcode != '' $group_sql $searchopt_sql $order_sql";
								                     ...
								                     $total = mysql_num_rows($result);
								                   	...
								                   	if($start>1) mysql_data_seek($result,$start);
															...
															<tr bgcolor="<?=$bgcolor?>">
															  ...
															  <td align="center"><?=$row->salecnt?></td>
