                                      ...
                                      <tr> 
                                        <td align="center" valign="top" bgcolor="#FFFFFF">
                                              ...
                                              <td bgcolor="D5D3D3">
                                                <table width="100%" border="0" cellspacing="1" cellpadding="3">
                                                  <tr> 
                                                    ...
                                                    <input type="checkbox" name="pay_method[]" value="PH" <? if($pay_method["PH"]==true) echo "checked";?>>PayPal 결제
                                                    </td>
                                                  </tr>
                                                  <tr> 
                                                    ...
                                                    <input name="pay_agent" value="Authorize.net" type="radio" class="form1" <? if($oper_info->pay_agent == "Authorize.net") echo "checked"; ?>> Authorize.net &nbsp;
                                                    </td>
                                                  </tr>
                                                  <tr>
                                          ...
                                          <table width="97%" border="4" cellpadding="10" cellspacing="0" bordercolor="E8E8C8">
                                            <tr>
                                              <td>
                                              - 이해가 가지 않는 부분이나 의문점이 있으시면 위즈샵 info@eznetsol.com 으로 문의하시기 바랍니다.
                                              </td>
                                            </tr>
                                          </table>
                                          <table width="97%" border="0" cellpadding="0" cellspacing="0">
