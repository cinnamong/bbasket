...
if($mode == "insert"){
   ...
   $sql = "insert into wiz_product values(   
						'$prdcode','$prdname','$model','$origin','$prdcom','$conprice','$sellprice','$buyprice','$reserve',

						'$popular','$recom','$new','$sale','$stock','$coop','$showset','$prior','$viewcnt','$salecnt',
						'$quantity','$changeprice','$copttitle','$copcode01','$coptprice01','$coptcode02','$coptprice02','$coptcode03','$coptprice03',
						'$coptcode04','$coptprice04','$coptcode05','$coptprice05','$copttitle','$optcode',
						'$opttitle2','$optcode2','$opttitle3','$optcode3','$prdimg_L1_name','$prdimg_M1_name','$prdimg_S1_name','$prdimg_A1_name',
						'$prdimg_L2_name','$prdimg_M2_name','$prdimg_S2_name','$prdimg_A2_name','$prdimg_L3_name','$prdimg_M3_name','$prdimg_S3_name',
						'$prdimg_A3_name','$prdimg_L4_name','$prdimg_M4_name','$prdimg_S4_name','$prdimg_A4_name','$movietype','$movieurl',
						'$stortexp','$content','$seller','$buycnt','$prdno','$prdimg_R_name','$shortage','$prefer','$searchkey','$savestock','$deimgcnt')";

//'$ProdInc','$Purl','$MallID','$Sprice','$Lprice','$origin','$showset','$stock','$savestock','$prior','$viewcnt','$deimgcnt', '$basketcnt', '$ordercnt', '$cancelcnt', '$comcnt',
...
//						'$searchkey','$stortexp','$content')";
   ...
   $sql = "update wiz_product set
                        prdcode='$prdcode',prdname='$prdname',prdcom='$prdcom',origin='$origin',showset='$showset',shortage='$shortage',prefer='$prefer',stock='$stock',prior='$prior',
								...
								searchkey='$searchkey',stortexp='$stortexp',content='$content',model='$model',prdno='$prdno' where prdcode = '$prdcode'";
...
// 진열순서
   ...
   if($posi == "up"){
   	...
   	$sql .= " and wp.prior >= '$prior' and wp.prdcode != '$prdcode' order by wp.prior asc  limit 2";
	...
	// 1단계아래로
		...
		$sql .= " and wp.prior <= '$prior' and wp.prdcode != '$prdcode' order by wp.prior desc  limit 2";
