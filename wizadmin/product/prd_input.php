...
//
$sql = "select prdimg_R, prdimg_S, prdimg_M, prdimg_L from wiz_designinfo";
$result = mysql_query($sql) or error(mysql_error());
$oper_info = mysql_fetch_object($result);
$prdimg_R = $oper_info->prdimg_R;
...
<? include "../inc/header.inc"; ?>
 ...
 <tr>
                                                    <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Prod No <font color="red">*</font></td>
                                                    <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <input type="text" name="prdno" value="<?=$prd_row->prdno?>" size="60" class="form1">
                                                    </td>
                                                </tr>
 <tr>
                                                    <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Model <font color="red">*</font></td>
                                                    <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <input type="text" name="model" value="<?=$prd_row->model?>" size="60" class="form1">
                                                    </td>
                                                </tr>
 <tr>
                                                    <td width="150" height="25" align="left" bgcolor="EAEAEA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search Key <font color="red">*</font></td>
                                                    <td width="550" bgcolor="F8F8F8" colspan="3">
                                                    <input type="text" name="searchkey" value="<?=$prd_row->searchkey?>" size="60" class="form1">
                                                    </td>
                                                </tr>
