...
if($mode == "insert"){
   ...
   $sql = "insert into wiz_category values('$catcode','$depthno','$priorno01','$priorno02','$priorno03',
								'$catname','$catimg_name','$subimg_name','$catuse','$recom_use','$menuthema','$recom_tema','$recom_num',
								
								'$prd_tema','$prd_num','$catimg_over_name','$subimg_type','$prd_width','$prd_height','$subimg','$catimg','$catimg_over')";
   ...
   $catname = str_replace("'","′",$catname);
	...
	$sql = "update wiz_category set catname='$catname', catuse='$catuse', catimg_name='$catimg_name', catimg='$catimg_name', catimg_over='$catimg_over_name', subimg='$subimg_name', subimg_type='$subimg_type',prd_tema='$prd_tema', prd_num='$prd_num', prd_width='$prd_width', prd_height='$prd_height', recom_use='$recom_use', recom_tema='$recom_tema', recom_num='$recom_num' where catcode = '$catcode'";
