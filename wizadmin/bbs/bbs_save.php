...
if($mode == "insert"){
	...
	$sql = "insert into wiz_bbs values('$idx', '$code', '$prino', '$subno', '$depno', '$notice', '$name', '$email', '$subject', '$content',
                                                        '$ctype', '$privacy', '$upfile_name', '$passwd', '$count', now(), '$REMOTE_ADDR', '$parno', '$grp', '$memid', '$upfile_tmp', '$upfile2_tmp', '$upfile3_tmp', '$upfile2_name', '$upfile3_name', '$recom')";
	...
	$sql = "insert into wiz_bbs values('', '$code', '$prino', '$subno', '$depno', '$notice', '$name', '$email', '$subject', '$content', 
							'$ctype', '$privacy', '$upfile_name', '$passwd', '$count', now(), '$REMOTE_ADDR', '$parno', '$grp', '$memid', '$upfile_tmp', '$upfile2_tmp', '$upfile3_tmp', '$upfile2_name', '$upfile3_name', '$recom')";
