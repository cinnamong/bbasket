                                                      ...
                                                      <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                          <td align="center" height="25">
                                                            ...
                                                            <option value="BM" <? if($bbs_info->lpermi == "BM") echo "selected"; ?>>부관리자
                                                            <option value="CM" <? if($bbs_info->lpermi == "CM") echo "selected"; ?>>우수회원
                                                            <option value="DM" <? if($bbs_info->lpermi == "DM") echo "selected"; ?>>정회원
                                                            <option value="EM" <? if($bbs_info->lpermi == "EM") echo "selected"; ?>>일반회원
                                                          ...
                                                          <td align="center">
                                                            ...
                                                            <option value="BM" <? if($bbs_info->rpermi == "BM") echo "selected"; ?>>부관리자
                                                            <option value="CM" <? if($bbs_info->rpermi == "CM") echo "selected"; ?>>우수회원
                                                            <option value="DM" <? if($bbs_info->rpermi == "DM") echo "selected"; ?>>정회원
                                                            <option value="EM" <? if($bbs_info->rpermi == "EM") echo "selected"; ?>>일반회원
                                                          ...
                                                          <td align="center">
                                                            ...
                                                            <option value="BM" <? if($bbs_info->wpermi == "BM") echo "selected"; ?>>부관리자
                                                            <option value="CM" <? if($bbs_info->wpermi == "CM") echo "selected"; ?>>우수회원
                                                            <option value="DM" <? if($bbs_info->wpermi == "DM") echo "selected"; ?>>정회원
                                                            <option value="EM" <? if($bbs_info->wpermi == "EM") echo "selected"; ?>>일반회원
                                                          ...
                                                          <td align="center">
                                                            ...
                                                            <option value="BM" <? if($bbs_info->apermi == "BM") echo "selected"; ?>>부관리자
                                                            <option value="CM" <? if($bbs_info->apermi == "CM") echo "selected"; ?>>우수회원
                                                            <option value="DM" <? if($bbs_info->apermi == "DM") echo "selected"; ?>>정회원
                                                            <option value="EM" <? if($bbs_info->apermi == "EM") echo "selected"; ?>>일반회원
                                                          ...
                                                          <td align="center">
                                                            ...
                                                            <option value="BM" <? if($bbs_info->cpermi == "BM") echo "selected"; ?>>부관리자
                                                            <option value="CM" <? if($bbs_info->cpermi == "CM") echo "selected"; ?>>우수회원
                                                            <option value="DM" <? if($bbs_info->cpermi == "DM") echo "selected"; ?>>정회원
                                                            <option value="EM" <? if($bbs_info->cpermi == "EM") echo "selected"; ?>>일반회원
