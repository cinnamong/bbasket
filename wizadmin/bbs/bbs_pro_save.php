...
if($mode == "insert"){
	...
	$sql = "insert into wiz_bbspro values('$code', '$title', '$titleimg_name', '$grp', '$lpermi', '$rpermi', '$wpermi', '$apermi', '$cpermi', 
	...
	$sql = "update wiz_bbspro set title='$title', $titleimg_sql grp='$grp', lpermi='$lpermi', rpermi='$rpermi', wpermi='$wpermi', apermi='$apermi', cpermi='$cpermi', 
	...
	$sql = "delete from wiz_bbspro where code = '$code'";
	$result = mysql_query($sql) or error(mysql_error());
	...
	$sql = "update wiz_bbspro set titleimg='' where code = '$code'";
