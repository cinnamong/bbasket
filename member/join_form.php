										    ...
										    <td style="padding:5">
											    <table border=0 cellpadding=0 cellspacing=0 width=100%>
													...
													<tr height=28>
														...
														<br><font color="#317FB1">* 주민번호가 없으신분은 빈칸으로 남겨두세요..</font></td>
												   </tr>
													<tr><td colspan=3 bgcolor=#eeeeee></td></tr>
													<?
													}?>
													...
													<tr height=28>
														...
														<br><font color="#317FB1">* 미국 거주자는 우편번호 첫칸에 ZIP Code 를 넣어주세요.</font></td>
												   </tr>
													<? 
													...
													<tr height=28>
													   <td></td>
														<td></td>
														<td><input type=text name="address2" size=80 class="input">
														<br><font color="#317FB1">* 미국거주자는 City, State, Zipcode 를 입력해 주세요.</font></td></tr>
													<tr><td colspan=3 bgcolor=#eeeeee></td></tr>
													...
													<tr height=70>
														...
														<td>
														  ...
														  <input type=text name="hphone3" size=4 class="input">&nbsp;
														<input name="resms" type="hidden" value="Y" style="border:0px; background-color:transparent;">
														<input name="resms" type="hidden" value="N" checked style="border:0px; background-color:transparent;">
														<br><font color="#317FB1">* 결제,주문확인,배송 등 문제가 발생시 연락할 수 있는 전화번호를 입력해 주세요.</font>
														</td></tr>
													<tr><td colspan=3 bgcolor=#eeeeee></td></tr>
													<?
													}
													...
													<tr height=70>
														...
														<td><input type=text name="email" size=30 class="input"><font color="#317FB1">* 이메일 주소를 입력해 주세요.</font>
														<br>
														 이메일 서비스를 받으시겠습니까?&nbsp;
													...
													<tr height=28>
														...
														<td><input type=text name="recom" size=20 class="input"><font color="#317FB1">* 추천인에게 적립금이 지급됩니다.</font></td></tr>
													</table>
										</td></tr>
										</table>
							</td></tr>
