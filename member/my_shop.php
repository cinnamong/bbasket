...
$page_type = "myshop";
$now_position = "<a href=/>Home</a> &gt; <b>마이쇼핑</b>";
...
//배송조회 보기
   function trackView(deliver_num){
   var url = "http://www.speedyexpress.net/byspeedy_traking_quary.php?invoice_no=" + deliver_num;
   window.open(url, "trackView", "height=650, width=736, menubar=no, scrollbars=yes, resizable=no, toolbar=no, status=no, left=0, top=0");
}
//-->
</script>
					...
					<tr><td align=center style="padding:5 0 10 0">
							...
							<tr><td><a href="../member/my_shop.php"><img src="/images/myshop_m_o_01.gif" border=0></a></td>
					...
					<tr><td align=center>
			            ...
			            ?>
							<tr align=center height=28>
								...
								<td></td>
								<td><a href="javascript:trackView('<?=$row->deliver_num?>');"><?=$row->deliver_num?></td>
								<td></td>
