<?
$sql = "select distinct wp.prdcode, wp.prdimg_R, wp.model, wp.prdno, wp.prdname, wp.sellprice, wp.prior, wp.stock from wiz_product wp, wiz_cprelation wc where wp.popular = 'Y' and wc.prdcode = wp.prdcode order by wp.prior desc, wp.prdcode desc limit 3";
